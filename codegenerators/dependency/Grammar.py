...
productions = {
	...
	'DEBUG_STATEMENT': [
		['KEYWORD_DEBUG', 'EXPRESSION_EXPRESSION'],
	],
	'EXPRESSION_EXPRESSION': [
	...
	'STATIC_OR_DYNAMIC_CONTROL': [
		['GROUPER_LEFT_BRACKET', 'EXPRESSION_EXPRESSION', 'GROUPER_RIGHT_BRACKET', 'SINGLE_STATEMENT_OR_CODE_BLOCK'],
		['GROUPER_LEFT_PARENTHESIS', 'EXPRESSION_EXPRESSION', 'GROUPER_RIGHT_PARENTHESIS', 'SINGLE_STATEMENT_OR_CODE_BLOCK'],
	],
	'ELSE_STATEMENT': [
		[],
