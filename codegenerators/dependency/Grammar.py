...
productions = {
	...
	'IF_STATEMENT': [
		['KEYWORD_IF', 'STATIC_OR_DYNAMIC_CONTROL'],
	],
	'TRY_BLOCK': [
	...
	'STATIC_OR_DYNAMIC_CONTROL': [
		['GROUPER_LEFT_BRACKET', 'EXPRESSION_EXPRESSION', 'GROUPER_RIGHT_BRACKET', 'SINGLE_STATEMENT_OR_CODE_BLOCK', 'ELSE_STATEMENT'],
		['GROUPER_LEFT_PARENTHESIS', 'EXPRESSION_EXPRESSION', 'GROUPER_RIGHT_PARENTHESIS', 'SINGLE_STATEMENT_OR_CODE_BLOCK', 'ELSE_STATEMENT'],
	],
	'CATCH_LIST': [
		[],
