...
################################################################################
	...
	'DATA_DECLARATION_STATEMENT': [
		['KEYWORD_VAR', 'TYPE', 'DATA_NAMES', 'OPTIONAL_ASSIGNMENT', 'OPTIONAL_DATA_DECLARATION'],
	],
	'GOTO_STATEMENT': [
...
################################################################################
	...
	'RESOURCE': [
		...
		['STRING'],
		['WHEN_EXPRESSION'],
		['KEYWORD_LAMBDA', 'GROUPER_LEFT_BRACKET', 'GROUPER_RIGHT_BRACKET', 'FUNCTION_SIGNATURE', 'GROUPER_LEFT_BRACE', 'GROUPER_RIGHT_BRACE']
	],
