...
################################################################################ 1
	'ENTER': [
		...
		['DATA_DECLARATION_STATEMENT', 'ENTER'],
...
################################################################################ 9
	...
	'GRANT_LIST': [
		['KEYWORD_VAR', 'TYPE', 'VARIABLE_NAMES', 'OPTIONAL_DATA_NAME_LIST', 'SYMBOL_SEMICOLON__PRUNE', 'OPTIONAL_GRANT_LIST'],
		['KEYWORD_STATIC', 'TYPE', 'VARIABLE_NAMES', 'OPTIONAL_DATA_NAME_LIST', 'SYMBOL_SEMICOLON__PRUNE', 'OPTIONAL_GRANT_LIST'],
...
################################################################################ 11
	...
	'DATA_DECLARATION_STATEMENT': [
		...
		['KEYWORD_STATIC', 'DATA_DECLARATION_TYPE'],
	],
	'DATA_DECLARATION_TYPE': [
