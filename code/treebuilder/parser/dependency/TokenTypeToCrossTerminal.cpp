		...
		namespace parser
		{
			namespace dependency
			{
				protocols::CrossTerminal TokenTypeToCrossTerminal::convertToCrossTerminal(protocols::TokenType token_type)
				{
					switch (token_type)
					{
						case protocols::TokenType::ARGUMENT_LISTGROUPER_RIGHT_PARENTHESIS: return protocols::CrossTerminal::ARGUMENT_LISTGROUPER_RIGHT_PARENTHESIS;
						...
						case protocols::TokenType::RELATIONAL_OPERATOR: return protocols::CrossTerminal::RELATIONAL_OPERATOR;
