    ...
    namespace dependency
    {
      CrossTerminalParser::CrossTerminalParser()
      {
        ...
        #define add(left, middle) \
          ...
          add(ENTER, KEYWORD_PRIVATE) {cT(ACCESS_SPECIFIER), cT(DECLARATION), cT(OPTIONAL_EQUALS), cT(SYMBOL_SEMICOLON), cT(FIELD_DECLARATION_LIST)});
          add(ENTER, KEYWORD_PUBLIC) {cT(ACCESS_SPECIFIER), cT(DECLARATION), cT(OPTIONAL_EQUALS), cT(SYMBOL_SEMICOLON), cT(FIELD_DECLARATION_LIST)});
          add(ENTER, KEYWORD_RESTRICTED) {cT(ACCESS_SPECIFIER), cT(DECLARATION), cT(OPTIONAL_EQUALS), cT(SYMBOL_SEMICOLON), cT(FIELD_DECLARATION_LIST)});

          add(FIELD_DECLARATION_LIST, KEYWORD_PRIVATE) {cT(ACCESS_SPECIFIER), cT(DECLARATION), cT(OPTIONAL_EQUALS), cT(SYMBOL_SEMICOLON), cT(FIELD_DECLARATION_LIST)});
          add(FIELD_DECLARATION_LIST, KEYWORD_PUBLIC) {cT(ACCESS_SPECIFIER), cT(DECLARATION), cT(OPTIONAL_EQUALS), cT(SYMBOL_SEMICOLON), cT(FIELD_DECLARATION_LIST)});
          add(FIELD_DECLARATION_LIST, KEYWORD_RESTRICTED) {cT(ACCESS_SPECIFIER), cT(DECLARATION), cT(OPTIONAL_EQUALS), cT(SYMBOL_SEMICOLON), cT(FIELD_DECLARATION_LIST)});
